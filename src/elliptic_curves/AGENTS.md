...
- When that generated-subgroup story is extended to several reduced
  generators, keep the closure algorithm and report in the same class-group
  module and describe it as an algebraic subgroup generated by local classes.
