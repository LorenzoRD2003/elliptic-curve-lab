use crate::elliptic_curves::{
    endomorphisms::{
        ...
        quadratic_orders::{
            ImaginaryQuadraticOrder, ImaginaryQuadraticOrderError,
            QuadraticDiscriminantFactorization,
        },
    },
    frobenius::{FrobeniusCurveType, FrobeniusDiscriminant, FrobeniusTrace},
};
    ...
    pub fn from_frobenius_discriminant(
        ...
        match frobenius_discriminant.frobenius_trace().curve_type() {
            FrobeniusCurveType::Ordinary => {
                let factorization =
                    QuadraticDiscriminantFactorization::from_frobenius_discriminant(
