...
use crate::elliptic_curves::analytic::{
    ...
    periods::{
        CubicRootConfiguration, CubicRootConfigurationReport, LegendreReduction,
        LegendreReductionReport, PeriodRecoveryConfig,
        legendre::{LEGENDRE_PERMUTATIONS, LegendreCandidate},
    },
};
...
impl WeierstrassCubicRoots {
    ...
    pub fn legendre_reduction(
        &self,
        tolerance: ApproxTolerance,
    ) -> Result<LegendreReduction, AnalyticCurveError> {
        LegendreReduction::from_roots(self, tolerance)
    }
    ...
    pub(crate) fn choose_legendre_candidate(
        ...
        for permutation in LEGENDRE_PERMUTATIONS {
            ...
            let candidate = LegendreCandidate::new(permutation, lambda);
