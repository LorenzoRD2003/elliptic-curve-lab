...
impl<F: FiniteField> MontgomeryCurve<F>
where
    F::Elem: Clone,
{
    ...
    /// - this wrapper is therefore unavailable in characteristic `3` until the
    ///   Montgomery model gains its own non-enumerative finite-field counting
    ///   route
