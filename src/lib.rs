...
pub use elliptic_curves::{
    ...
    LegendreReduction, LiftXCoordinate, ModNMatrix2, ModularMatrix, ModularQParameter,
    NTorsionBasis, PeriodRecoveryConfig, PointIndexSampler, PointOrderFromMultipleReport,
    PointOrderReductionStep, PointOrderReport, PointOrderStrategy, PointOrderStrategyKind,
    QExpansionTruncation, QuadraticDiscriminant, QuadraticDiscriminantFactorization,
