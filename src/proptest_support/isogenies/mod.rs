...
pub(crate) fn touch_isogeny_inventory() {
    ...
    let _ = arb_short_weierstrass_function_field_map_case::<17>(config);
    let _ = arb_composable_short_weierstrass_function_field_map_case::<17>(config);
    ...
    let _ = core::mem::size_of::<FunctionFieldMapCase<17>>();
    let _ = core::mem::size_of::<ComposableFunctionFieldMapCase<17>>();
