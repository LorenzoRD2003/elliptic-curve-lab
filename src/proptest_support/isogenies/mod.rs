...
pub use graphs::{VolcanicFloorSearchCase, arb_volcanic_floor_search_case};
...
pub(crate) fn touch_isogeny_inventory() {
    ...
    let _ = arb_volcanic_floor_search_case();
    ...
    let _ = core::mem::size_of::<VolcanicFloorSearchCase>();
    ...
    graphs::touch_volcanic_floor_search_case_fields();
