...
pub use elliptic_curves::{
    ...
    describe_complex_lattice, describe_curve, describe_eisenstein_sum,
    ...
    describe_membership, describe_modular_invariance_report, describe_modular_matrix,
    describe_order_distribution, describe_point, describe_point_order, describe_q_parameter,
    describe_scalar_mul, describe_torus_to_curve_map, describe_truncation_convergence,
